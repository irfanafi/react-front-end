...
class ReceiverDetails extends React.Component{
    render(){
        return(
            <div class="sender">
                ...
                <div class="sender-body">
                    <div class="sender-details-table">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="input-div">
                                <input type="text" class="form-control" id="cname" txt_c_name="" placeholder="Receiver Name"/>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="icon-div">
                            ...
                            <div class="input-div">
                                <input type="text" class="form-control" id="cname" txt_c_name="" placeholder="Receiver Email"/>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="icon-div">
                            ...
                            <div class="input-div">
                                <input type="tel" class="form-control" id="cname" txt_c_name="" placeholder="Receiver Phone No."/>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="icon-div">
